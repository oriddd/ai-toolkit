...
## How to contribute
1. **New Skills**: If you identify a recurring pattern not yet captured, propose a new skill in `skills/public/`. Follow `skills/AUTHORING.md`.
...
- Ensure `bash skills/validate-skills.sh` passes before submitting.
